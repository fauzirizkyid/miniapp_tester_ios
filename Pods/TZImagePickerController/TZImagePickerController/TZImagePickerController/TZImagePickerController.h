...
/// Default is NO, if set YES, the original photo button will checked. user can't change the values.
/// 默认为NO，如果设置为YES,原图按钮将不可点击，用户只能选择发送原图
@property (nonatomic, assign) BOOL onlyPickingOriginalPhoto;
