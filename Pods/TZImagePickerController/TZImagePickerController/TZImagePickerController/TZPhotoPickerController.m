...
- (void)viewDidLoad {
    ...
    _isSelectOriginalPhoto = tzImagePickerVc.isSelectOriginalPhoto || tzImagePickerVc.onlyPickingOriginalPhoto;
...
- (void)configBottomToolBar {
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.enabled = tzImagePickerVc.selectedModels.count > 0 || tzImagePickerVc.onlyPickingOriginalPhoto;
...
//        _originalPhotoButton.imageEdgeInsets = UIEdgeInsetsMake(0, 0, 0, -titleSize.width);
    ...
    [_previewButton resetFrameToFitRTL];
