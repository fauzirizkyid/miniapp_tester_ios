...
@interface TFBLPromise<Value>(AnyAdditions)
 ...
 */
+ (TFBLPromise<NSArray *> *)any:(NSArray *)promises NS_SWIFT_UNAVAILABLE("");
...
/**
 Convenience dot-syntax wrappers for `TFBLPromise` `any` operators.
 Usage: TFBLPromise.any(@[ ... ])
 */
@interface TFBLPromise<Value>(DotSyntax_AnyAdditions)

+ (TFBLPromise<NSArray *> * (^)(NSArray *))any FBL_PROMISES_DOT_SYNTAX NS_SWIFT_UNAVAILABLE("");
+ (TFBLPromise<NSArray *> * (^)(dispatch_queue_t, NSArray *))anyOn FBL_PROMISES_DOT_SYNTAX
