...
BOOL TFBLWaitForPromisesWithTimeout(NSTimeInterval timeout) {
  BOOL isTimedOut = NO;
  ...
  dispatch_group_t dispatchGroup = TFBLPromise.dispatchGroup;
...
@implementation TFBLPromise (TestingAdditions)

// These properties are implemented in the TFBLPromise class itself.
@dynamic isPending;
@dynamic isFulfilled;
@dynamic isRejected;
