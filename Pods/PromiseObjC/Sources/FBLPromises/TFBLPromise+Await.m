...
id __nullable TFBLPromiseAwait(TFBLPromise *promise, NSError **outError) {
  assert(promise);

  static dispatch_once_t onceToken;
  static dispatch_queue_t queue;
  dispatch_once(&onceToken, ^{
    queue = dispatch_queue_create("com.google.TFBLPromises.Await", DISPATCH_QUEUE_CONCURRENT);
  });
